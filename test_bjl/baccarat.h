...
#pragma omp parallel for
	...
	void setInitCard(std::vector<int> banker, std::vector<int> player) {

		initBanker = banker;
		initPlayer = player;

		leftCard[initBanker[0]]--;
		leftCard[initBanker[1]]--;
		leftCard[initPlayer[0]]--;
		leftCard[initPlayer[1]]--;
	}
...
private:
	...
	std::vector<int> initBanker;
	std::vector<int> initPlayer;
	//int leftCardNum = 0;
};